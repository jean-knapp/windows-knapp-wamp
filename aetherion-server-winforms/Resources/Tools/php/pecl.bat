...
FOR %%x IN ("[[BASE_DIRECTORY_BACKSLASH]]\Tools\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=[[BASE_DIRECTORY_BACKSLASH]]\Tools\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=[[BASE_DIRECTORY_BACKSLASH]]\Tools\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=[[BASE_DIRECTORY_BACKSLASH]]\Tools\php\php.exe"
GOTO :INSTALLED
