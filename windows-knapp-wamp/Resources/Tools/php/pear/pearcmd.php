...
if ('[[BASE_DIRECTORY_BACKSLASH]]\Tools\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('[[BASE_DIRECTORY_BACKSLASH]]\Tools\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
